...
namespace Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        ///
        /// <seealso cref="Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="Zip.ZipEntry.Extract(string, ExtractExistingFileAction)"/>
        ///
        /// <example>
        ...
        ///
        /// <seealso cref="Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="Zip.ZipEntry.ExtractWithPassword(ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        ///
        /// <para>
        ...
        ///   cref="Zip.ZipEntry.ExtractExistingFile"/>property, or call
        ///   <see
        ...
        ///
        /// <seealso cref="Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="Zip.ZipEntry.ExtractWithPassword(string, ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        /// <para>
        ///   Existing entries in the filesystem will not be overwritten. If you
        ...
        ///   cref="Crc.CrcCalculatorStream"/>.  Use it as you would any
        ...
        ///   cref="Crc.CrcCalculatorStream.Crc"/> property on the
        ...
        ///   using (Zlib.CrcCalculatorStream s = e1.OpenReader())
        ///   {
        ...
        ///       Using s As Zlib.CrcCalculatorStream = e1.OpenReader
        ///           Dim n As Integer
        ...
        /// </code>
        /// </example>
        /// <seealso cref="Zip.ZipEntry.Extract(System.IO.Stream)"/>
        ...
        internal void CalcWinZipAesMac(Stream input)
        {
                ...
                Encryption == EncryptionAlgorithm.WinZipAes256)
            {
                ...
                else if (input is Zlib.CrcCalculatorStream)
                {
                    xxx;
                }
        ...
        private Int32 ExtractOne(Stream output)
        {
            ...
            try
            {
                ...
                // workitem 10178
                Zip.SharedUtilities.Workaround_Ladybug318918(input);
        ...
        internal void _SetTimes(string fileOrDirectory, bool isFile)
        {
            ...
            try
            {
                ...
                {
                    // workitem 6191
                    DateTime AdjustedLastModified = Zip.SharedUtilities.AdjustTime_Reverse(LastModified);
