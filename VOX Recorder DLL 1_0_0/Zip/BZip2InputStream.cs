...
// compile: msbuild
// not: csc.exe /t:library /debug+ /out:BZip2.dll BZip2InputStream.cs BCRC32.cs Rand.cs
...
namespace BZip2
{
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly Crc.CRC32 crc = new Crc.CRC32(true);
        private int nInUse;
        ...
        ///   {
        ///       using (var decompressor = new BZip2.BZip2InputStream(fs))
        ///       {
