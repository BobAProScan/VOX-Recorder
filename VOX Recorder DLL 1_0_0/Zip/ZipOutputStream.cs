...
// generating zip files.  This class does not depend on Zip.ZipFile, but rather
...
namespace Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = Zip.ZipOutputStream.DefaultEncoding;
...
#if !NETCF
        public Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
