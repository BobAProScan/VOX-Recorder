...
namespace Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            Misc.FileSelector ff = new Misc.FileSelector(selectionCriteria,
...
namespace Misc
{
    ...
    {
        internal abstract bool Evaluate(Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(Zip.ZipEntry entry)
        {
    ...
    public partial class FileSelector
    {
        ...
        public ICollection<Zip.ZipEntry> SelectEntries(Zip.ZipFile zip)
        {
            if (zip == null)
