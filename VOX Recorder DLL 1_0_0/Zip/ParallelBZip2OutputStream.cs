...
namespace BZip2
{
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="BZip2.BZip2OutputStream"/>,
    ...
    /// </para>
    ///
    /// <seealso cref="BZip2.BZip2OutputStream" />
    public class ParallelBZip2OutputStream : System.IO.Stream
    {
        ...
        ///       {
        ///           using (var compressor = new BZip2.ParallelBZip2OutputStream(output))
        ///           {
