...
namespace Zip
{
    ...
    public partial class ZipFile
    {
        ...
        ///
        /// <exception cref="Zip.BadStateException">
        ...
        /// {
        ///     zip.CompressionLevel= Zlib.CompressionLevel.BestCompression;
        ...
        /// {
        ///   using (var zip = Zip.ZipFile.Read(inputStream))
        ///   {
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = Zip.ZipFile.Read(filename))
        /// {
        ///     zip.AddEntry("Name1.txt", "this is the content");
        ///     zip.Save();  // YES!
        /// }
